	var WhichBrowser = (function() {
	    ...
	    WhichBrowser.prototype = {
	        initialize: function(options) {
	            ...
	            this.browser = new Browser({ channel: "Dev", stock: false, hidden: false, mode: "", name: "Chrome", version: new Version({ value: "63.0.3239.132", hidden: false }) });
	            this.engine = new Engine({ name: "Blink", version: new Version({ value: "537.36", hidden: false }) });
	            this.os = new Os({ name: "OS X", version: new Version({ value: "10.12.2", hidden: false, details: 2 }) });
	        ...
	        isBrowser: function() { var a = Array.prototype.slice.call(arguments);
	            a.unshift('browser'); return this.isX.apply(this, a); },
	        isEngine: function() { var a = Array.prototype.slice.call(arguments);
	            a.unshift('engine'); return this.isX.apply(this, a); },
	        isOs: function() { var a = Array.prototype.slice.call(arguments);
	            a.unshift('os'); return this.isX.apply(this, a); },
